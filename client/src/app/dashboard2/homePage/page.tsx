...
export default function Homepage() {
  return (
    <div 
      ...
      style={{ backgroundImage: `url('/imageExpense/image5.webp')`, backgroundColor: '#f0f0f0' }} // Adding a fallback background color
    >
      ...
      <div className="flex-grow bg-white relative">
        ...
        >
          ...
          {/* Adding image on top of the box */}
...
// export default function Homepage() {
//   return (
//     <div className="bg-cover bg-center h-screen" style={{ backgroundImage: `url('/imageExpense/image5.jpeg')` }}>
//     <div className="flex min-h-screen">
//       {/* Navbar/Sidebar */}
//       <nav className="bg-gradient-to-t from-indigo-400 to-indigo-700 dark:bg-zinc-800/30 w-30 p-4 flex flex-col justify-between">
//         {/* Icons */}
